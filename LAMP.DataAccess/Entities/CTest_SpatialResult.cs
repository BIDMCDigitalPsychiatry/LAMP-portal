...
namespace LAMP.DataAccess.Entities
{
    ...
    public partial class CTest_SpatialResult
    {
        public CTest_SpatialResult()
        {
            this.CTest_SpatialResultDtl = new HashSet<CTest_SpatialResultDtl>();
        }
        ...
        public virtual ICollection<CTest_SpatialResultDtl> CTest_SpatialResultDtl { get; set; }
    }
}
