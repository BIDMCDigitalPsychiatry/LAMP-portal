...
namespace LAMP.DataAccess.Entities
{
    ...
    public partial class CTest_TrailsBDotTouchResult
    {
        public CTest_TrailsBDotTouchResult()
        {
            this.CTest_TrailsBDotTouchResultDtl = new HashSet<CTest_TrailsBDotTouchResultDtl>();
        }
        ...
        public virtual ICollection<CTest_TrailsBDotTouchResultDtl> CTest_TrailsBDotTouchResultDtl { get; set; }
    }
}
