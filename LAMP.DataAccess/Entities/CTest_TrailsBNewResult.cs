...
namespace LAMP.DataAccess.Entities
{
    ...
    public partial class CTest_TrailsBNewResult
    {
        public CTest_TrailsBNewResult()
        {
            this.CTest_TrailsBNewResultDtl = new HashSet<CTest_TrailsBNewResultDtl>();
        }
        ...
        public virtual ICollection<CTest_TrailsBNewResultDtl> CTest_TrailsBNewResultDtl { get; set; }
    }
}
