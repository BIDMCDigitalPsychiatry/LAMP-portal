...
namespace LAMP.DataAccess.Entities
{
    ...
    public partial class CTest_TrailsBResult
    {
        public CTest_TrailsBResult()
        {
            this.CTest_TrailsBResultDtl = new HashSet<CTest_TrailsBResultDtl>();
        }
        ...
        public virtual ICollection<CTest_TrailsBResultDtl> CTest_TrailsBResultDtl { get; set; }
    }
}
